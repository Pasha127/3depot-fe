      ...
      <div className="lights-toggle-container">
        ...
        >
          <div className="lightbulb-container">
            ...
            <LightbulbFill
              className={`lightbulb-color ${lightOnState}`}
        ...
        >
          ...
          <div className="sliders-container">
            <div
              className="color-label label-position1"
              style={{
                color: `rgb(${red},0,0)`,
            ...
            <div
              className="color-label label-position2"
              style={{
                color: `rgb(0,${green},0)`,
            ...
            <div
              className="color-label label-position3"
              style={{
                color: `rgb(0,0,${blue})`,
