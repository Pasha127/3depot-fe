    ...
    <>
      ...
      <div className="drag-container">
        <div id="comment-tray" className={trayState}>
          <div
            className="comment-tray-details"
            onClick={(e) => {
              e.stopPropagation();
            }}
          >
            {props.activeAsset._id ? (
              commentEntries
            ) : (
              <div>
                Load up a model from the search or from your device and you can
          ...
          <X
            className="comment-tray-close-icon"
            onClick={(e) => {
              e.stopPropagation();
              handleToggle();
              console.log("click");
