...
const ModelsTab = (props) => {
  ...
  return (<>      
        ...
        <div className="model-tray-details"
          ...
          >
            {props.user?.uploads ? props.user.uploads.map(asset=>{
              ...
              return(<UploadedItem key={`Model_Tab_${asset._id}`} _id={asset._id} modelName={asset.name} pic={assetImage}/>)
            }):<div>Once you register and upload some 3D models, you'll see them listed here.</div>}
          </div>
