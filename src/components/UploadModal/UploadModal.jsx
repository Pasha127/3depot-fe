      ...
      >
        ...
        <Modal.Body>
          ...
          <div className="filetype-buttons">
            <Button
              ref={objBtn}
              className={`filetype-btn ${objClick}`}
              variant="outline-dark"
              onClick={(e) => {
                /* handleFileTypes(e) */ alert("OBJ support coming soon!");
              }}
            >
              OBJ
            </Button>
            <Button
              ref={fbxBtn}
              className={`filetype-btn ${fbxClick}`}
              variant="outline-dark"
              onClick={(e) => {
                handleFileTypes(e);
              }}
            ...
            <Button
              ref={gltfBtn}
              className={`filetype-btn ${gltfClick}`}
              variant="outline-dark"
              onClick={(e) => {
                /* handleFileTypes(e) */ alert("GLTF support coming soon!");
              }}
            >
              GLTF
            </Button>
          ...
          <input
            placeholder="humanoid low-poly blender..."
            type="text"
            className="model-name"
            value={keywords}
            onChange={(e) => {
          ...
          {!props.user?._id && (
            <h3 className="log-in-msg" onClick={goToLogin}>
              Log-in Required{" "}
            </h3>
          )}
        </Modal.Body>
