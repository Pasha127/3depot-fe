      ...
      >
        ...
        <Modal.Body>
          ...
          <div className="messenger-icons">
            ...
            >
              {" "}
              <Messenger onClick={copyCurrentUrl} />{" "}
            </a>
            <a
              className="share-link-icon"
              target="_blank"
            ...
            >
              {" "}
              <Whatsapp onClick={copyCurrentUrl} />{" "}
            </a>
            <a
              className="share-link-icon"
              target="_blank"
            ...
            >
              {" "}
              <Instagram onClick={copyCurrentUrl} />{" "}
            </a>
            <a
              className="share-link-icon"
              target="_blank"
            ...
            >
              {" "}
              <Facebook onClick={copyCurrentUrl} />{" "}
            </a>
            <a
              className="share-link-icon"
              target="_blank"
            ...
            >
              {" "}
              <Telegram onClick={copyCurrentUrl} />{" "}
            </a>
          </div>
          {!props.user?._id && (
            <p className="modal-section-head">
              Log in to send direct messages!
            </p>
          )}
          {props.user?._id && (
            <p className="modal-section-head">Send 3Depot message:</p>
          )}
          {props.user?._id && (
            <div className="tDepot-convo-container">
              {props.history
                .slice()
                .sort(
                  (a, b) =>
                  ...
                  return (
                    ...
                    >
                      <UserMini
                        person={person}
                        thisChat={chat}
                        getChat={getRelevantChatForPerson}
                      />
                    </div>
                  );
                })}
